...
export const HorizontalLine = ({ svgName }: HorizontalLineProps) => {
	switch (svgName) {
		case "timeline":
			return (
				...
				<div className="inline-flex w-full items-center justify-center">
					...
					<div className="absolute left-1/2 -translate-x-1/2 px-4 dark:bg-gray-900">
						<svg height="40px" width="40px" viewBox="0 0 512 512">
							<g>
								<path
									d="M314.022,167.059c-21.788,0-41.358,0-60.564,0H0v91.268l122.43,21.778c23.356,4.153,43.101,19.682,52.644,41.4
    ...
    c0-28.939,23.464-52.413,52.408-52.413c28.944,0,52.408,23.474,52.408,52.413C366.43,332.008,342.966,355.472,314.022,355.472z"
								/>
								<path
									d="M375.991,72.922c-40.945,0-274.535,0-274.535,0L2.008,144.233h145.575h125.84h40.94
